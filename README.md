...
frameworks, and reporting systems that drive measurable business outcomes.

- 🎓 M.S. in Analytics — American University (Kogod School of Business)
- 📊 Delivered **$6M+ in measurable business impact** through predictive analytics,
  A/B testing, automated reporting, and pricing/segmentation work
...
- **[scalable-behavioral-clustering](https://github.com/mosaeed2400/scalable-behavioral-clustering)**
  — ML pipeline architecture for clustering large-scale behavioral data under
  memory/scalability constraints.
